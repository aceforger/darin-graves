        ...
        <div className="bg-[#09090A] p-10 inline-block shadow-2xl border border-[#FF4500]/20 animate-fade-in-up-delayed-2 hover-lift">
          ...
          <div className="space-y-4">
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 bg-[#FF4500] text-white font-rajdhani font-bold uppercase tracking-[0.15em] hover:bg-[#E63946] transition-all text-lg w-full justify-center"
            >
